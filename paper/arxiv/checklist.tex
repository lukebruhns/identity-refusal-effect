...
\item {\bf Claims}
    ...
    \item[] Justification: The abstract states specific numerical claims (9.2\% Purity refusal, 3.5\% to 1.0\% reduction, binding gap narrowing) that are directly supported by the experimental results in Section~4. Limitations are discussed in Section~5.7.
